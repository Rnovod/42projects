...
inline	static	const	char	*ft_mng_flags(t_data *d, const char *pos)
{
	while (*pos && (*pos == ' ' ||
		*pos == '0' || *pos == '-' ||
		*pos == '#' || *pos == '+' ||
...
inline	static	const	char	*ft_mng_dig(t_data *d, const char *pos)
{
	int		digit;
...
inline	static	const	char	*ft_mng_prec(t_data *d,
