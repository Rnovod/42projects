...
inline	static	void	ft_put_index(t_data *d, int i)
{
...
inline	static	void	ft_chartype_array(t_data *d, char **array)
{
...
inline	static	void	ft_wchartype_array(t_data *d, wchar_t **array)
{
	const int	width = d->width;
	const int	prec = d->prec;
	int			i;
